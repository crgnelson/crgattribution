...
start_date = pd.to_datetime("2024-12-24")  # Start of the range
...
user_df_all = pd.merge(user_df_all, ltv_df, left_on=['product_arrangement_id', 'run_date'], right_on=['product_arrangement_id', 'product_order_timestamp'], how='left')
...
normalized_removal_effects_all = normalized_removal_effects_all[normalized_removal_effects_all['removal_effect'] != 0]
normalized_removal_effects_all= pd.merge(normalized_removal_effects_all, average_ltv_per_channel, left_on = ("channel", "conversion_window", "conversion_type", "run_date"), right_on = ("channel", "conversion_window", "conversion_type", "run_date"), how = "left")
