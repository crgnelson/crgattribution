...
# Updated table_id to reflect the 30-day window
table_id = "ft-customer-analytics.crg_nniu.conversion_visit_static_30"
...
# Updated variable names from _60 to _30
...
# Update the conversion window to 30
...
attribution_df_all = attribution_df_all_subs_30
normalized_removal_effects_all = normalized_removal_effects_all_subs_30
markov_transition_matrix_all = markov_transition_matrix_all_subs_30
user_df_all = user_df_all_subs_30
...
user_df_trial_avg['conversion_window'] = 30
